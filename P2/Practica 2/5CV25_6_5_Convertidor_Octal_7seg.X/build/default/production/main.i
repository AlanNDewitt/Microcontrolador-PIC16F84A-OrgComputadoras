...
void main(void) {
    ...
    while (1)
    {
        ...
        else if(PORTA == 0b1010)
        {
            PORTB = 0b00010010;
        }
        else if(PORTA == 0b1011)
        {
            PORTB = 0b00010011;
        }
        else if(PORTA == 0b1100)
        {
            PORTB = 0b00010100;
        }
        else if(PORTA == 0b1101)
        {
            PORTB = 0b00010101;
        }
        else if(PORTA == 0b1110)
        {
            PORTB = 0b00010110;
        }
        else if(PORTA == 0b1111)
        {
            PORTB = 0b00010111;
        }
        else if(PORTA == 0b10000)
        {
            PORTB = 0b00100000;
        }
        else if(PORTA == 0b10001)
        {
            PORTB = 0b00100001;
        }
        else if(PORTA == 0b10010)
        {
            PORTB = 0b00100010;
        }
        else if(PORTA == 0b10011)
        {
            PORTB = 0b00100011;
        }
        else if(PORTA == 0b10100)
        {
            PORTB = 0b00100100;
        }
        else if(PORTA == 0b10101)
        {
            PORTB = 0b00100101;
        }
        else if(PORTA == 0b10110)
        {
            PORTB = 0b00100110;
        }
        else if(PORTA == 0b10111)
        {
            PORTB = 0b00100111;
        }
        else if(PORTA == 0b11000)
        {
            PORTB = 0b00110000;
        }
        else if(PORTA == 0b11001)
        {
            PORTB = 0b00110001;
        }
        else if(PORTA == 0b11010)
        {
            PORTB = 0b00110010;
        }
        else if(PORTA == 0b11011)
        {
            PORTB = 0b00110011;
        }
        else if(PORTA == 0b11100)
        {
            PORTB = 0b00110100;
        }
        else if(PORTA == 0b11101)
        {
            PORTB = 0b00110101;
        }
        else if(PORTA == 0b11110)
        {
            PORTB = 0b00110110;
        }
        else if(PORTA == 0b11111)
        {
            PORTB = 0b00110111;
        }
